...
* The original package name 'com.soap.webservice.soap-course-management' is invalid and this project uses 'com.soap.webservice.soapcoursemanagement' instead.
...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/3.3.0-M1/reference/htmlsingle/index.html#io.webservices)
